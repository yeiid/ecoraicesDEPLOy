      ...
      style: {
        ...
        sources: {
          ...
          "martin-vector": {
            type: "vector",
            tiles: [
              "https://map.neuraljira.tech/tiles/geo2/{z}/{x}/{y}.pbf"
            ]
          }
        },
        layers: [
      ...
      mapInstance.on("click", (e) => {
        ...
        if (activeMarkerRef.current) {
          ...
          activeMarkerRef.current = new maplibregl.Marker({ color: "#ef4444" })
            .setLngLat([lng, lat])
            .setPopup(new maplibregl.Popup({ offset: 25 }).setHTML("<p style='margin:0; font-family:sans-serif;'><b>Ubicación seleccionada</b></p>"))
            .addTo(mapInstance);
        }
      });
    }
